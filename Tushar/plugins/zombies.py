...
@Tushar.on(events.NewMessage(pattern="^[!?/]zombies ?(.*)"))
@is_admin
...
@Tushar.on(events.callbackquery.CallbackQuery(data="zombies"))
async def _(event):
    await event.edit(CLEANER_HELP, buttons=[[Button.inline("« Back", data="help")]])
